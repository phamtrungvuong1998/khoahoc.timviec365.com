        ...
        <div class="modal-content">
            ...
            <div class="modal-content1">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Đăng nhập trung tâm, giảng viên</h5>
                </div>
                <div id="error_ajax1"></div>
                <form class="modal-body" onsubmit="return popuplogin()">
                    <div class="signbody">
                        <div class="signbody1">
                        ...
                        <div class="signbody1">
                            <input type="hidden" id="choose_login_input">
                        </div>
                        <div class="signbody2">
                ...
                <div class="modal-footer">
                    ...
                    <div class="divfootsign1">Nếu bạn chưa đăng ký? <a href="/hop-tac-giang-day.html">Đăng ký</a></div>
                </div>
            </div>
        </div>
    </div>
