...
$db_count = new db_query("SELECT count(cit_cate_id) as total FROM `city_categories`");
            ...
            <center id="v_info_ad">
                <div class="title_input" id="title_manager">
                    ...
                    if ($start < 0) {
                        ...
                        $qr = new db_query("SELECT cate_name,cit_name,cit_cate_id FROM city_categories INNER JOIN categories ON categories.cate_id = city_categories.cate_id INNER JOIN city ON city.cit_id = city_categories.city_id LIMIT $start, $limit");
                    ...
                    ?>
                            <div class="manager remove" id="manager_2">
                                ...
                                <!-- <div class="v_title_student"></?php echo $rowHV['cate_name']; ?></div> -->
                                <div class="v_title_student"><a href="admin_update_cate_city.php?id=<? echo $rowHV['cit_cate_id']; ?>"><img id="admin_edit<?php echo $rowHV['cit_cate_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                            </div>
                    <?php
                            $i++;
                        }
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a class="l_phantrang_btn" href="admin_list_category_off_city.php?page='. ($current_page - 1) .'">&lt;</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $current_page) {
                        ...
                        echo '<a class="l_phantrang_btn" href="admin_list_category_off_city.php?page=' . $i . '">' . $i . '</a>';
                    }
                }
