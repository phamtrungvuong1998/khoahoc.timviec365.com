                ...
                <div class="title_input" id="title_manager">
                    ...
                    ?>
                        <div class="manager remove" id="manager_2">
                            ...
                            <div class="v_title_student"><a href="admin_update_category.php?id=<? echo $rowHV['cate_id']; ?>&type=2"><img id="admin_edit<?php echo $rowHV['cate_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                        </div>
                    <?php
                        $i++;
                    }
