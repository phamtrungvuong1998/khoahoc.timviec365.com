    ...
    <div class="templatemo-flex-row">
        ...
        <div class="templatemo-content col-1 light-gray-bg">
            ...
            <!-- action="../ajax/admin_create_post.php" method="POST" -->
                <form onsubmit="validate_update_center(<? echo $cit_id; ?>);">
                    ...
                    <div class="v_detail_student">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="<? echo $row_city['cit_name'] ?>" id="title" readonly>
                    ...
                    <div class="v_detail_student">
                        <div>Nội dung:</div>
                        <div>
                            <textarea name="content" id="content" cols="" rows=""><? echo $row_city['content'] ?></textarea>
                        </div>
                    </div>
                    <p id="l_error1" class="l_error"></p>
                    <div class="v_detail_student">
                        ...
                        <div>
                            <input type="text" name="title" value="<? echo $row_city['title_suggest'] ?>" id="title_suggest">
                        </div>
                    </div>
                    <p id="l_error2" class="l_error"></p>
                    <div class="v_detail_student">
                        ...
                        <div>
                            <textarea name="content_suggest" id="content_suggest" cols="" rows=""><? echo $row_city['content_suggest'] ?></textarea>
                        </div>
                    </div>
                    <p id="l_error3" class="l_error"></p>
                    <div><button onclick="validate_update_center(<? echo $cit_id; ?>);" type="button" name="create_student" id="update_student">Cập nhật</button></div>
                </form>
            </center>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function validate_update_center(a) {
        ...
        $.ajax({
            url: '../ajax/admin_list_post_off_city.php',
            type: "post",
            data: data,
            dataType: 'json',
            contentType: false,
