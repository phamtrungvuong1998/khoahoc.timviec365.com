        ...
        <div class="templatemo-content col-1 light-gray-bg">
            ...
            <center id="v_info_ad">
                <div class="title_input" id="title_manager">
                    ...
                    <?php 
        $i = 1;
        $qr = new db_query("SELECT * FROM history_point JOIN users ON users.user_id = history_point.center_teacher_id  ORDER BY history_point_id DESC LIMIT 0, 30");
          ...
          ?>
                    <div class="manager" id="manager<?php echo $rowHV['user_id'];?>">
                        ...
                        <div class="v_title_student"><a
                                href="/Admin/admin_history_point_add.php?user_id=<?php echo $rowHV['user_id'];?> "><?php echo $rowHV['point_add']; ?></a>
                        </div>
                        <div class="v_title_student"><a
                                href="/Admin/admin_history_point_minus.php?user_id=<?php echo $rowHV['user_id'];?>"><?php echo $rowHV['point_minus']; ?></a>
                        </div>
                    </div>
                    <?php
          $i++;
