...
$db_count = new db_query("SELECT count(cit_id) as total FROM `city` where cit_parent = 0");
            ...
            <center id="v_info_ad">
                <div class="title_input" id="title_manager">
                    <div id="manager">
                        ...
                        <div class="v_title_student">ID</div>
                    ...
                    if ($start < 0) {
                        ...
                        $qr = new db_query("SELECT * FROM city where cit_parent = 0 LIMIT $start, $limit");
                        // $count = new db_query("SELECT * FROM city where cit_parent = 0");
                    ...
                    ?>
                            <div class="manager remove" id="manager_2">
                                ...
                                <div class="v_title_student"><?php echo $rowHV['cit_id']; ?></div>
                                <div class="v_title_student"><?php echo $rowHV['cit_name']; ?></div>
                                <!-- <div class="v_title_student"><?php echo $rowHV['cate_name']; ?></div> -->
                                <div class="v_title_student"><a href="admin_update_city.php?id=<? echo $rowHV['cit_id']; ?>"><img id="admin_edit<?php echo $rowHV['tag_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                            </div>
                    <?php
                            $i++;
                        }
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a class="l_phantrang_btn" href="admin_list_post_off_city.php?page='. ($current_page - 1) .'">&lt;</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $current_page) {
                        ...
                        echo '<a class="l_phantrang_btn" href="admin_list_post_off_city.php?page=' . $i . '">' . $i . '</a>';
                    }
                }
