                ...
                <div class="title_input" id="title_manager">
                    ...
                    ?>
                            <div class="manager remove" id="manager_2">
                                ...
                                <div class="v_title_student"><a href="admin_update_tag.php?id=<? echo $rowHV['tag_id']; ?>&type=3"><img id="admin_edit<?php echo $rowHV['tag_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                            </div>
                    <?php
                            $i++;
                        }
