        ...
        <div class="templatemo-content col-1 light-gray-bg">
            ...
            <center id="v_info_ad">
                <div class="title_input" id="title_manager">
                    ...
                    ?>
                            <div class="manager remove" id="manager_2">
                                ...
                                <div class="v_title_student"><a href="admin_update_tag.php?id=<? echo $rowHV['tag_id']; ?>&type=2"><img id="admin_edit<?php echo $rowHV['tag_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                            </div>
                    <?php
                            $i++;
                        }
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a class="l_phantrang_btn" href="admin_list_tags.php?page='. ($current_page - 1) .'">&lt;</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $current_page) {
                        ...
                        echo '<a class="l_phantrang_btn" href="admin_list_tags.php?page=' . $i . '">' . $i . '</a>';
                    }
                }
