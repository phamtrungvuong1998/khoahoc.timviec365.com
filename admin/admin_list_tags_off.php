...
$db_count = new db_query("SELECT count(tag_id) as total FROM `tags`");
            ...
            <center id="v_info_ad">
                <div class="title_input" id="title_manager">
                    <div id="manager">
                        ...
                        <div class="v_title_student">Mã môn học chi tiết</div>
                        <div class="v_title_student">Tên môn học chi tiết</div>
                    ...
                    if ($start < 0) {
                        ...
                        $qr = new db_query("SELECT * FROM tags INNER JOIN categories ON categories.cate_id = tags.cate_id LIMIT $start, $limit");
                    ...
                    ?>
                            <div class="manager remove" id="manager_2">
                                ...
                                <div class="v_title_student"><?php echo $rowHV['tag_id']; ?></div>
                                <div class="v_title_student"><?php echo $rowHV['tag_name']; ?></div>
                                <div class="v_title_student"><?php echo $rowHV['cate_name']; ?></div>
                                <div class="v_title_student"><a href="admin_update_tag.php?id=<? echo $rowHV['tag_id']; ?>&type=1"><img id="admin_edit<?php echo $rowHV['tag_id']; ?>" src="../img/vv_edi.svg" alt="Ảnh lỗi"></a></div>
                            </div>
                    <?php
                            $i++;
                        }
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a class="l_phantrang_btn" href="admin_list_tags_off.php?page='. ($current_page - 1) .'">&lt;</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $current_page) {
                        ...
                        echo '<a class="l_phantrang_btn" href="admin_list_tags_off.php?page=' . $i . '">' . $i . '</a>';
                    }
                }
