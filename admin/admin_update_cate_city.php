...
$db_city_tag = new db_query("SELECT cit_name,cate_name,city_categories.content,city_categories.title_suggest,city_categories.content_suggest FROM city_categories INNER JOIN categories ON categories.cate_id = city_categories.cate_id INNER JOIN city ON city.cit_id = city_categories.city_id WHERE cit_cate_id = '$city_tag_id'");
            ...
            <center id="v_info_ad">
                <form onsubmit="validate_update_center(<? echo $city_tag_id; ?>);">
                    <div class="v_detail_student">
                        <div>Môn học:</div>
                        <div>
                            <input type="text" name="title" value="<? echo $row_city_tag['cate_name']?>" id="title" readonly>
                        </div>
                    </div>
                    <div class="v_detail_student">
...
<script type="text/javascript">
    ...
    function validate_update_center(a) {
        ...
        if (flag == true) {
            ...
            $.ajax({
                url: '../ajax/admin_update_cate_city.php',
                type: "post",
                data: data,
                dataType: 'json',
                contentType: false,
