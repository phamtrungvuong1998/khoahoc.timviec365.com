...
<head>
    ...
    <style type="text/css">
        ...
        #v_sidebar-tb-2 li:nth-child(3) a{
            color: #1B6AAB;
        }
    ...
    <title>Danh sách khóa học online đã lưu</title>
</head>
                        ...
                        while ($row = mysql_fetch_array($qr->result)) {
                            ...
                            if (mysql_num_rows($qrOrder->result) == 0) {
                                ...
                                $order2 = '<a class="flex v_ghichu-mb">
                                        <p class="v_ghichu-mb-p v_gc">ĐÃ MUA</p>
                                    </a>';
                            }
                            ?>
                            <div class="v_noidungkh" id="v_noidungkh-<?php echo $row['save_id']; ?>">
                                ...
                                <div class="v_table-cell v_content-list v_monhoc">
                                    <a href="<?php echo urlDetail_courseOnline($row['course_id'],$row['course_slug']); ?>"><?php echo $row['course_name']; ?></a>
                                </div>
                            ...
                            <div class="v_content-mb" id="v_content-mb-<?php echo $row['save_id']; ?>">
                                <div class="flex v_content-mb-div">
                                    ...
                                    <a class="v_content-mb-title" href="<?php echo urlDetail_courseOnline($row['course_id'],$row['course_slug']); ?>">
                                        <?php echo $row['course_name']; ?>
                                    </a>
                                </div>
                                <a class="v_tengiangvien" href="<?php echo $linkT; ?>"><?php echo $row['user_name']; ?></a>
