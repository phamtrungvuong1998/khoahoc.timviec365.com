...
require_once '../code_xu_ly/h_update_class_center.php';
            ...
            <div class="container">
                ...
                <div class="post-course">
                    ...
                    <div class="post-course1">
                        <form onsubmit="return course_online_onsubmit()" method="POST" enctype="multipart/form-data"
                            name="v_couse_online">
                            <div class="post1">
                                <div class="post11">
                                    <div class="form-group">
                                        <label id="v_course-label-2">Tên khóa học</label>
                                        <input type="text" id="course_name" value="<? echo $rowqr['course_name']; ?>"
                                            name="course_name" placeholder="VD : Thành thạo tiếng anh trong 30 ngày ">
                                        <p id="v_course_online-1"></p>
                                    </div>
                                    <div class="form-group">
                                        <label id="v_course-label-4">Mô tả thêm</label>
                                        <input type="text" id="course_describe"
                                            value="<? echo $rowqr['course_describe']; ?>" name="course_describe"
                                            placeholder="VD : Trọn bộ kỹ năng tiếng anh giao tiếp cơ bản ">
                                    </div>
                                    <p id="v_course_online-2"></p>
                                </div>
                                <div class="post12">
                                    <img id="avatar" onerror="this.onerror=null;this.src='../img/avatar/error.png';"
                                        src="../img/course/<? echo $rowqr['course_avatar']; ?>">
                            ...
                            <div class="post2">
                                <div class="form-group">
                                    <label>Môn học</label>
                                    <select class="cate2" name="cate_id" id="cate_id" onchange="tags()">
                                        <option value="0">Chọn Môn học</option>
                                        <?php
                                        $qrCate = new db_query("SELECT * FROM categories");
                                        while ($rowCate = mysql_fetch_array($qrCate->result)) {
                                        ?>
                                        <option <? if ($rowqr['cate_id']==$rowCate['cate_id']) { echo "selected" ; } ?>
                                            class="catet2db" value="<?php echo $rowCate['cate_id']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($rowqr['tag_id'] != 0) {
                                        $qrTag = new db_query("SELECT * FROM tags WHERE cate_id = " . $rowqr['cate_id']);
                                    }
                                    ?>
                                    <select class="tag2" id="tag2" name="tag_id">
                                        ...
                                        while ($rowTag = mysql_fetch_array($qrTag->result)) {
                                            if ($rowTag['tag_id'] == $rowqr['tag_id']) {
                                                $sel = "selected";
                                            }else{
                                                $sel = "";
                                            }
                                        ?>
                                        <option class="tag2db" value="<?php echo $rowTag['tag_id'] ?>" <?php echo $sel; ?>><?php echo $rowTag['tag_name'] ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="form-group onlinegv">
                                ...
                                <select class="teach2" id="teach2" onchange="teach_2()" name="center_teacher">
                                    ...
                                    <?php
                                    $qrGV = new db_query("SELECT * FROM user_center_teacher WHERE user_id = '$cookie_id'");
                                    while ($rowGV = mysql_fetch_assoc($qrGV->result)) {
                                    ?>
                                    <option <? if ($rowqr['center_teacher_id']==$rowGV['center_teacher_id']) {
                                        echo "selected" ; } ?>
                                        class="teach2db"
                                        value="<?php echo $rowGV['center_teacher_id']; ?>">
                            ...
                            <div class="post3" id="v_course-label-5">
                                <div class="form-group">
                                    ...
                                    <textarea name="course_benefit"
                                        id="course_benefit"><? echo $rowqr['course_benefit']; ?></textarea>
                                </div>
                            ...
                            <div class="post3" id="v_course-label-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="course_match"
                                        id="course_match"><? echo $rowqr['course_match']; ?></textarea>
                                </div>
                            ...
                            <div class="post3" id="v_course-label-7">
                                <div class="form-group">
                                    ...
                                    <textarea name="course_request"
                                        id="course_request"><? echo $rowqr['course_request'] ?></textarea>
                                </div>
                            ...
                            <div class="post3" id="v_course-label-8">
                                <div class="form-group">
                                    ...
                                    <textarea name="general_describe"
                                        id="general_describe"><? echo $rowqr['general_describe']; ?></textarea>
                                </div>
                                    ...
                                    <div class="certification2">
                                        <div class="form-group">
                                            <input name="certification"
                                                <?php if ($rowqr['certification'] == 1) echo "checked"; ?> value="1"
                                                type="radio"><label>Có</label>
                                        </div>
                                        <div class="form-group">
                                            <input name="certification"
                                                <?php if ($rowqr['certification'] != 1) echo "checked"; ?> value="2"
                                                type="radio"><label>Không</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="post3 postlv">
                                ...
                                <div class="second2">
                                    ...
                                    ?>
                                    <div class="form-group">
                                        <input <? if ($rowqr['level_id']==$row['level_id']) { echo "checked" ; } ?>
                                        id="radio" type="radio" value="<?= $row['level_id'] ?>" name="level_id">
                            ...
                            <div class="post3 post33">
                                ...
                                <?
                                    $on = $rowqr['advantages_id'];
                                    $on_ex = explode(',', $on);
                                    $db_adv = new db_query("SELECT * FROM advantages_center  WHERE advantages_type = 0");
                                    while ($row = mysql_fetch_array($db_adv->result)) {
                                    ?>
                                <div class="form-group">
                                    <input <? for ($i=0; $i < count($on_ex); $i++) { if
                                        ($row['advantages_id']==$on_ex[$i]) { echo "checked" ; } } ?> class="ckeck"
                                    id="l_idcheck<?= $row['advantages_id']; ?>" type="checkbox"
                                    value="<?= $row['advantages_id'] ?>" name="advantages_id[]">
                                    <label
                                        for="l_idcheck<?= $row['advantages_id']; ?>"><?= $row['advantages_name'] ?></label>
                                </div>
                                <?php
                                    }
                                    ?>
                            ...
                            <div class="post4">
                                <button name="btn_online" id="btnpost">LƯU LẠI</button>
                                <button name="btn_next" id="btnnext">TIẾP TỤC</button>
                            </div>
                        </form>
                    </div>
                </div>
...
function course_online_onsubmit() {
    ...
    $.ajax({
        url: '../code_xu_ly/v_update_course.php',
        type: 'POST',
        cache: false,
        contentType: false,
        processData: false,
...
// function l_validate_submit(id) {
//     var flag = course_online_onsubmit();
//     if (flag == true) {
//         var course_name = document.getElementById('course_name').value;
//         var course_describe = document.getElementById('course_describe').value;
//         var cate_id = document.getElementById('cate_id').value
//         var avatar = $('#img')[0].files[0];
//         var tag2 = document.getElementById('tag2').value;
//         var teach2 = document.getElementById('teach2').value;
//         var course_benefit = document.getElementById('course_benefit').value;
//         var course_match = document.getElementById('course_match').value;
//         var course_request = document.getElementById('course_request').value;
//         var general_describe = document.getElementById('general_describe').value;
//         var radio = $('input[name="certification"]:checked').val();
//         var level_id = $('input[name="level_id"]:checked').val();
//         var l_check = [];
//         var addtienich = $('#addtienich').val();
//         $(".ckeck").each(function() {
//             if ($(this).is(":checked")) {
...
//         data.append('course_describe', course_describe);
//         data.append('avatar', avatar);
//         data.append('tag2', tag2);
//         data.append('teach2', teach2);
//         data.append('course_benefit', course_benefit);
//         data.append('course_match', course_match);
//         data.append('course_request', course_request);
//         data.append('general_describe', general_describe);
//         data.append('radio', radio);
//         data.append('level_id', level_id);
//         data.append('cate_id', cate_id);
//         data.append('l_check', l_check);
//         data.append('addtienich', addtienich);
//         $.ajax({
//             url: '../ajax/l_ajax_update_onlineTT.php',
//             type: 'post',
//             data: data,
//             dataType: 'json',
//             contentType: false,
...
//                     $("#thongbao").append('<div class="alert-success">' + response.message + '</div>');
//                     setTimeout(function() {
