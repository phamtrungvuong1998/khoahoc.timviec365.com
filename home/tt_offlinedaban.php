...
$db_count = new db_query("SELECT count(order_id) as total FROM `orders` INNER JOIN users ON orders.user_student_id = users.user_id INNER JOIN courses ON orders.course_id = courses.course_id WHERE orders.course_type = 1 AND courses.user_id = '$user_id'");
...
//$db_point = new db_query("SELECT count(order_id) as total FROM `orders` INNER JOIN users ON orders.user_student_id = users.user_id INNER JOIN courses ON orders.course_id = courses.course_id WHERE orders.course_type = 2 AND courses.user_id = '$user_id' ORDER BY course_id DESC LIMIT $start , $limit");
...
<head>
    ...
    <title>Khóa học offline đã đặt chỗ</title>
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <?php
    include '../includes/l_inc_head.php';
    ?>
    <link rel="stylesheet" href="../css/tt_offlinedaban.css?v=<?=$version?>">
    ...
    <div class="l_container">
        ...
        <div class="l_right">
            ...
            <div class="l_chucnang">
                ...
                <div class="l_excel">
                    <a href="../code_xu_ly/l_xls_offlinedaban.php">
            ...
            <div class="l_content">
                ...
                ?>
                    ...
                    <?
                    $db_order = new db_query("SELECT * FROM `orders` INNER JOIN users ON orders.user_student_id = users.user_id INNER JOIN courses ON orders.course_id = courses.course_id WHERE orders.course_type = 1 AND courses.user_id = '$user_id' ORDER BY order_id DESC LIMIT $start , $limit");
                    ...
                    ?>
                        <div class="l_noidungkh">
                            ...
                            <div class="l_table-cell">
                                <a href="<? echo urlDetail_courseOffline($row['course_id'], $row['course_slug']); ?>">
                                    <p class="p">
                                        <?
                            ...
                            <div class="l_curson" onclick="l_chinhsua(<?php echo $row['order_id']; ?>)">
                                <img src="../img/More.svg" alt="loading...">
                            </div>
                            <div class="l_hienthi_chinhsua" id="l_hienthi_chinhsua<?php echo $row['order_id']; ?>">
                                <button class="l_btn_chinhsua">
                                    <img src="../img/l_chinhsua.svg" alt="loading..." class="l_img_chinhsua">
                    ...
                    <center>
                        <div class="v_content-mb">
                            ...
                            <div class="flex v_info-all v_content-mb-div">
                                ...
                                <div class="v_content-mb-thongtin"><span class="v_content-mb-span">Học phí: </span><?php 
            ...
            <div class="l_phantrang">
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a class="l_phantrang_btn" href="/trung-tam-khoa-hoc-offline-da-dat-cho/id' . $user_id . '&page' . ($current_page - 1) . '.html">&lt;</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($i == $current_page) {
                        ...
                        echo '<a class="l_phantrang_btn" href="/trung-tam-khoa-hoc-offline-da-dat-cho/id' . $user_id . '&page' . $i . '.html">' . $i . '</a>';
                    }
                }
...
<script>
    // function l_trangthai( id,p) {
    //     //var b = 'l_trangthai'+ id;
    //     var a = $('#l_trangthai' + id).val();
    //     if (s == '') {
    //         window.location.href = '/trung-tam-khoa-hoc-offline-da-ban/id'+ id +'&page'+ p +'.html';
    //         return false;
    //     }
    ...
    function l_search(id, p) {
        ...
        $.get("../ajax/l_ajax_search_offlineDB.php", {
                search: s,
                p: p
            },
            function(data) {
