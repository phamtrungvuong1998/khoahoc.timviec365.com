...
<head>
    ...
    <title>Danh sách khóa học offline đã đặt chỗ</title>
</head>
                    ...
                    if (mysql_num_rows($qr->result) == 0) {
                       ...
                       while ($row = mysql_fetch_array($qr->result)) { 
                            ...
                            <div class="v_table-cell v_content-list v_bacham">
                                <button class="v_btn-bacham" onclick="v_popup(this)"><img
                                    ...
                                    <div class="v_popup">
                                        ...
                                        <center><a href="<?php echo urlDetail_courseOffline($row['course_id'], $row['course_slug']) ?>"><button class="v_btn-del">XEM THÊM</button></a></center>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex v_mb-ghichu-all v_content-mb-div">
                            ...
                            <div class="v_ghichu-mb v_xemthem"><i><a href="<?php echo urlDetail_courseOffline($row['course_id'], $row['course_slug']) ?>">Xem thêm</a></i></div>
                        </div>
                    </div>
                    <?php 
                    $i++;
