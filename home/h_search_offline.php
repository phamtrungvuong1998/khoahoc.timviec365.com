...
if ($cate_id != 0) {
    if ($cit_id == 0) {
        ...
        $search_key = "Danh sách Khóa học " . $cate_name . " tại " . $rown['cit_name'];
    }
} else if ($tag_id != 0) {
    if ($cit_id == 0) {
        ...
        $rown = mysql_fetch_array($names->result);
        $search_key = "Danh sách " . $rown['tag_name'] . " ở " . $rown['cit_name'];
    }
} else if ($keyword != "") {
    if ($cit_id == 0) {
        ...
        $rown = mysql_fetch_array($names->result);
        $search_key = "Danh sách Khóa học $key tại " . $rown['cit_name'];
    }
} else if ($cit_id != 0) {
    ...
    $names = new db_query("SELECT cit_name FROM city  WHERE cit_id = '$cit_id'");
    $rown = mysql_fetch_array($names->result);
    $search_key = "Danh sách Khóa học tại " . $rown['cit_name'];
}
                ...
                <div class="main-category1">
                    ...
                    <div class="main-category">
                        <div class="category">
                            ...
                            <ul class="cate-subj">
                                <li><img class="lazyload" src="/img/load.gif" data-src="../img/image/allsubj.svg"><a href="/khoa-hoc-offline.html">Tất cả môn học</a>
                                </li>
                                <?
