...
$query = "SELECT * FROM users WHERE user_type = 2" . $qr_id . $qr_name . $qr_email . $qr_phone . $qr_start . $qr_end ." ORDER BY user_id DESC LIMIT ". $page .", 30";
$qr = new db_query($query);
$qr_count = new db_query("SELECT * FROM users WHERE user_type = 2" . $qr_id . $qr_name . $qr_email . $qr_phone . $qr_start . $qr_end ." ORDER BY user_id DESC");
